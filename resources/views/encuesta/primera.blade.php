                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form>
                            ...
                            {{-- 14 --}}
                            <hr>
                            En caso de que algun familiar estuddie
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label for="familiar_nombre" class="form-label fw-bold">Nombre:</label>
                                    <input type="text" class="form-control" id="familiar_nombre"
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="familiar_edad" class="form-label fw-bold">Nivel de estudio:</label>
                                    <input type="text" class="form-control" id="familiar_edad" name="familiar_edad"
                                        required>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="familiar_parentesco" class="form-label fw-bold">Institución:</label>
                                    <input type="text" class="form-control" id="familiar_parentesco"
                                        name="familiar_parentesco" required>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="casa_dvd" name="casa_dvd"
                                        required>
                                </div>
                                <div class="col-md-6 mb-3">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="casa_fax" name="casa_fax"
                                        required>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="discapacidad_especifique"
                                        class="form-label fw-bold">Especifique:</label>
